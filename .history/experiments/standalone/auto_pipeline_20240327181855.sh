...
gpu_index=0 seed=1 comm_round=1000 algorithm=FedSAM HPFL=False  wandb_key=52b3fac9fa69e6ffc4a0160f881c732eca640dbc plug_choose=plug_no_ood bash base_hpfl.sh&
...
gpu_index=1 seed=1 comm_round=1000 wandb_key=52b3fac9fa69e6ffc4a0160f881c732eca640dbc plug_choose=plug_ood bash base_hpfl.sh&
