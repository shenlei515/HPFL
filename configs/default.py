...
_C.wandb_key = 'WANDB_KEY_EXAMPLE'
...
_C.gpu_index = 4  # for centralized training or standalone usage
...
_C.HPFL=True
# _C.HPFL=True
_C.HPFL_local_iteration=10

# block the error KeyError: 'name'
_C.trainer_param_groups=False
_C.select_with_distance=True
_C.select_with_KL=False
_C.select_with_CCA=True
_C.select_multi_Pluggable=True
_C.num_Pluggable=5
_C.freeze_layer = 1
_C.central_trainning_epoch=0 # 0 represent no centralize trianning
_C.feature_reduction_dim=64
_C.non_iid_for_batch_data=True
if _C.partition_alpha==0.1:
        _C.CCA_sample=512//(4*_C.client_num_in_total//10)
elif _C.partition_alpha==0.05:
        _C.CCA_sample=256//(4*_C.client_num_in_total//10)
_C.if_eval=True
_C.if_OOD=False
_C.OOD_independ_classifier=True
_C.OOD_feat_noise=True
_C.OOD_noise_option="random"
# _C.OOD_noise_option="other_real_data"
_C.freeze_OOD_backbone=True
_C.CCA_component=5
_C.noise_on_feat=True
_C.noise_on_test_feat=False
_C.noisy_coefficient=1
_C.noise_type="stat"
_C.group_feat=False
...
#fintuning FedAvg
_C.finetune_FedAvg=False

# Federated Continous Learning
_C.fedavg_cfl=False
_C.fcl_freeze_backbone = True

# FedTHE
_C.FedTHE_alpha = 0.1
_C.FedTHE_beta = 0.3
_C.FedTHE_finetune = True

# GFL+HPFL
_C.load_backbone_from = None

# FedSAM
_C.rho = 0.1
_C.eta = 0

_C.reduce_plug = False
_C.reduce_threshold = 0.02
